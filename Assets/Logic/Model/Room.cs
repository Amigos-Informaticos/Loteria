...
public class Room
{
    ...
    public List<KeyValuePair<string, string>> Messages { get; } =
    ...
    public string GetMessages(string email)
    {
        ...
        try
        {
            obtainedMessages = SimpleJson.DeserializeObject<Dictionary<string,
        ...
        if (obtainedMessages != null)
        {
            ...
            {
                this.Messages.Add(new KeyValuePair<string,
                    string>(obtainedMessages[i.ToString()]["nickname"],
    ...
    public bool SetRoomConfigByJson(string json)
    {
        ...
        try
        {
            Dictionary<string, string> roomConfig =
                SimpleJson.DeserializeObject<Dictionary<string, string>>(json);
